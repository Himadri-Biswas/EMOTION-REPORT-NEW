...
\node[lbl, right=0.3cm of patch] {196 patches};
...
%% Scale 0.52 maps the ~12cm-tall report diagram to ~6.2cm, fitting Beamer.
\begin{center}
\scalebox{0.43}{%
\begin{tikzpicture}[
...
%% ── Nodes (exact order as report Figure 2) ───────────────────────
...
\node[block, below left=1cm and 0.5cm of embed]
                             (cross)   {Cross-Attention\\with Image Features};

\node[block, below=of cross, minimum height=3cm, fill=purple!30, text width=5.5cm]
    (decoder) {
        \begin{tabular}{c}
...
%% ── Autoregressive loop: right then up (matches report Figure 2) ─
...
\begin{frame}{Limitations \& Future Work}
    ...
    \begin{itemize}
        ...
        \item BLEU scores lower than reference paper due to resource constraints
    \end{itemize}

    \vspace{0.4cm}
    \textbf{Future Directions:}
    \begin{itemize}
        \item \textbf{End-to-end training} with emotion as a direct input signal
...
\begin{frame}{Conclusion}
    ...
    \begin{block}{Summary of Achievements}
        \begin{itemize}
            ...
            \item Achieved \textbf{METEOR 22.59\%} on Flickr30k test set
